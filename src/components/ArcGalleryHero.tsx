      ...
      <div className="relative z-10 flex-1 flex items-center justify-center px-6 -mt-40 md:-mt-52 lg:-mt-64">
        <div className="text-center max-w-2xl px-6 opacity-0 animate-fade-in" style={{ animationDelay: '800ms', animationFillMode: 'forwards' }}>
          ...
          <p className="mt-4 text-lg text-muted-foreground">
            Коронки, виниры, имплантаты и протезы — высокая точность цифровых технологий на службе вашей улыбки.
          </p>
          <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-4">
            <a href="mailto:a.luzyakov@yandex.ru?subject=Заявка с сайта&body=Здравствуйте! Хочу оставить заявку." className="w-full sm:w-auto px-6 py-3 rounded-full bg-primary text-primary-foreground hover:bg-primary/90 transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 text-center">
              Оставить заявку
            </a>
